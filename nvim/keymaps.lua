...
-- Folding --
vim.keymap.set("n", "<leader>f0", "zRzO", noremap_silent("Unfold everything"))
vim.keymap.set("n", "<leader>f1", "zRzMzO", noremap_silent("Fold to level 1"))
vim.keymap.set("n", "<leader>f2", "zRzMzrzO", noremap_silent("Fold to level 2"))
vim.keymap.set("n", "<leader>f3", "zRzMzrzrzO", noremap_silent("Fold to level 3"))
...
vim.keymap.set("n", "<leader>bA", "<cmd>%bd<cr><cmd>Neotree<cr>", noremap_silent("Close all buffers but not Neotree"))
